...
import { ArrowLeft, BookOpen, Sparkles, Award, Play, Eye, BrainCircuit, Activity, Trash2, Edit, CheckCircle, Video, Image, FileText, Check } from "lucide-react";
...
export default function LessonDetail() {
  ...
  const lesson = mockLessonsData[id] || {
        ...
        <CardContent className="pt-6">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            ...
            <div className="flex gap-3 shrink-0">
              <Button variant="outline" className="border-white/10 text-gray-300 hover:bg-white/[0.04] hover:text-white flex items-center gap-1.5">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="border-white/[0.08]">
            <CardHeader className="border-b border-white/[0.04] flex flex-row items-center justify-between pb-4">
              ...
              <Button size="sm" variant="outline" className="border-white/10 hover:bg-white/[0.04] text-xs">
                Edit Quiz
              </Button>
            </CardHeader>
