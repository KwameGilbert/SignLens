...
SEQUENCE_LENGTH = 30
DATASET_PATH = os.path.join(os.path.dirname(__file__), '..', '..', 'dataset', 'static_keypoints')
MODEL_PATH = os.path.join(os.path.dirname(__file__), '..', 'saved_models', 'sign_language_model_keypoint.h5')
...
def main():
    ...
    with mp_holistic.Holistic(static_image_mode=False) as holistic:
        while cap.isOpened():
            ...
            cv2.imshow('SignLens Keypoint Model', frame)
