...
DATA_PATH = os.path.join(os.path.dirname(__file__), '..', 'dataset_video_keypoints_no_face')
SEQUENCE_LENGTH = 30
...
def main():
    ...
    model_path = get_versioned_model_path(os.path.join(os.path.dirname(__file__), 'sign_language_model_video.h5'))
